...
{	
	 ...
	 */
	public static final String DATE_FORMAT = Config.getProperty(JSON.class,"DATE_FORMAT","MM/dd/yyyy HH:mm:ss:SSS");
	...
	public abstract <T> T fromJson(String json, Class<?> classOfT);
	 ...
	 private static String instanceClassName = Config.getProperty(JSON.class,"instanceClassName","nyla.solutions.global.json.GSON");
